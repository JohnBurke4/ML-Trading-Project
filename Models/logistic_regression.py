...
def cvalues(day):
    ...
    for q in q_range:
        ...
        plt.legend(['Logistic Regression no Penalty','Logistic Regression L1','Logistic Regression L2','Logistic Regression L1 + L2','Baseline Classifier: Most Frequent','Baseline Classifier: Uniform'])
    plt.show()
...
def reports(c1,c2,c3,day,q):
    ...
    print("L1 + L2 Penalty Logistic Regression")
